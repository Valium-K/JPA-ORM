...
<h2><a name="#et">임베디드 타입 (복합값 타입)</a></h2>
![img.png](img.png)
...
```
<h2><a name="#cvt">컬렉션 값 타입</a></h2>
* `@ElementCollection`, `@CollectionTable` 사용
* DB에 컬렉션을 저장 할 수 없으므로 별도의 테이블을 생성함
* 지연 로딩이 기본
* 복합 값 타입의 컬렉션은 update시에 **해당 타입 자체를 교체해야한다.**

<h2><a name="#cpvt">컬렉션 + 기본 값 타입</a></h2>
* 컬렉션 + 기본 값 타입

<h2><a name="#cet">컬렉션 + 임베디드 타입</a></h2>
* 컬렉션 + 임베디드 타입
...
<h2><a name="#cvtau">컬렉션 값 타입의 실사용</a></h2>
